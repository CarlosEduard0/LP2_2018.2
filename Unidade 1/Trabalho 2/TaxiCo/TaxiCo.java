...
public class TaxiCo
{
    ...
    public Vehicle catchTaxi(String destination) {
        Vehicle find = null;
        for(Vehicle vehicle : vehicleFleet) {
            if(vehicle instanceof Taxi && vehicle.getDestination() == null) {
                find = vehicle;
            } else if(vehicle instanceof Shuttle && vehicle.getDestination() == destination) {
                find = vehicle;
                break;
            }
        }
